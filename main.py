...
#SEARCH
@app.get("/search") 
def search(female_no: str = None, shed: str = None, min_kids: int = None,colour: str=None, db: Session = Depends(get_db)): return crud.search_minks(db, female_no, shed, min_kids)
